					...
					<div class="span9">
						<div class="widget">
							...
							<div class="tab-content">
								...
								<form id="edit-profile" class="form-horizontal" action="${pageContext.request.contextPath}/addQuestionSecondTypeSecond" method="post" enctype="multipart/form-data" />
									<fieldset>
											...
											<div class="controls">
												<select id="belongtype" name="belongtypeno">
													<c:forEach items="${questionFirstTypeList }" var="questionFirstType">
														<option value="${questionFirstType.typeno }">${questionFirstType.typename }</option>
													</c:forEach>
												</select>
											</div>
										</div>
