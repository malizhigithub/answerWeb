					...
					<div class="span9">
						<div class="widget">
							...
							<div class="tab-content">
								...
								<form id="edit-profile" class="form-horizontal" action="${pageContext.request.contextPath}/updateQuestionThreeTypeSecond?pn=${pn}" method="post" enctype="multipart/form-data" />
									<fieldset>
											...
											<div class="controls">
												<select id="belongtype" name="belongtypeno">
													<c:forEach items="${questionSecondTypeList }" var="questionSecondType">
														...
														<option 
														<c:if test="${questionSecondType.typeno == questionType.belongtypeno}">selected</c:if>
														value="${questionSecondType.typeno }">${questionSecondType.typename }</option>
													</c:forEach>
												</select>
											</div>
										</div>
