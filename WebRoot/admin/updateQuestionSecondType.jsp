					...
					<div class="span9">
						<div class="widget">
							...
							<div class="tab-content">
								...
								<form id="edit-profile" class="form-horizontal" action="${pageContext.request.contextPath}/updateQuestionSecondTypeSecond?pn=${pn}&toid=${toid}" method="post" enctype="multipart/form-data" />
									<fieldset>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<select id="belongtype" name="belongtypeno">
													<c:forEach items="${questionFirstTypeList }" var="questionFirstType">
														
														<option 
														<c:if test="${questionFirstType.typeno == questionType.belongtypeno}">selected</c:if>
														value="${questionFirstType.typeno }">${questionFirstType.typename }</option>
													</c:forEach>
												</select>
											</div>
										</div>
										...
										<div class="control-group">											
											...
											<div class="controls">
													...
													<c:if test="${ questionType.imageurl != null }">
														<img src="http://cn-malizhi-answerweb.gz.bcebos.com/resource/images/type/${questionType.imageurl}" style="width:150px;height:150px;" id="showimg"/>
													</c:if>
											</div>
										</div>
