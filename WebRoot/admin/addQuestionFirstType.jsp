					...
					<div class="span9">
						<div class="widget">
							...
							<div class="tab-content">
								...
								<form id="edit-profile" class="form-horizontal" action="${pageContext.request.contextPath}/addQuestionFirstType" method="post" enctype="multipart/form-data" />
									<fieldset>
